...
async function getUsers(request, response, next) {
  try {
    // nomor halaman dari query parameter atau default 1 jika tidak diisi
    const page_number = parseInt(request.query.page_number) || 1;
    // jumlah data per halaman dari query parameter atau menampilkan semua data dalam 1 halaman jika tidak diisi
    const page_size = parseInt(request.query.page_size) || 0;
    // query parameter untuk pencarian data
    const search = request.query.search;
    // query parameter untuk sorting data
